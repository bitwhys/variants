...
/**
 * The `CommandEmpty` of shadcx/ui will cause the cmdk empty not rendering correctly.
 * So we create one and copy the `Empty` implementation from `cmdk`.
 *
 * @reference: https://github.com/hsuanyi-chou/shadcx-ui-expansions/issues/34#issuecomment-1949561607
 **/
...
>(({ className, ...props }, forwardedRef) => {
  ...
  return (
    <div
      ref={forwardedRef}
      className={cx('px-2 py-4 text-center text-sm', className)}
      cmdk-empty=""
      role="presentation"
      {...props}
    />
  ...
  (
    ...
    return (
      <Command
        ...
        className={cx('h-auto overflow-visible bg-transparent', commandProps?.className)}
        shouldFilter={
